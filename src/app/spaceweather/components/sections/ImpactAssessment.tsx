            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-space-section rounded-lg border border-space-border hover:border-space-border-hover transition-colors">
                    ...
                    <div className="space-y-1 text-sm">
                        <p>
                            <span className="text-space-text-muted">Risk:</span>{" "}
                            <span
                                className={
                        ...
                        <p>
                            <span className="text-space-text-muted">Surface Charging:</span>{" "}
                            <span className="text-space-text-main">{impacts.satellites.surfaceCharging}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Drag:</span>{" "}
                            <span className="text-space-text-main">{impacts.satellites.dragIncrease}</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="p-4 bg-space-section rounded-lg border border-space-border hover:border-space-border-hover transition-colors">
                    ...
                    <div className="space-y-1 text-sm">
                        <p>
                            <span className="text-space-text-muted">Radiation:</span>{" "}
                            <span className="text-red-400 font-bold">{impacts.aviation.radiationLevel}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Polar Routes:</span>{" "}
                        ...
                        <p>
                            <span className="text-space-text-muted">Communication:</span>{" "}
                            <span className="text-space-text-main">{impacts.aviation.communicationImpact}</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="p-4 bg-space-section rounded-lg border border-space-border hover:border-space-border-hover transition-colors">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <p>
                            <span className="text-space-text-muted">GIC Level:</span>{" "}
                            <span className="text-space-text-main">{impacts.powerGrids.gicLevel}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Regions:</span>{" "}
                            <span className="text-space-text-main">{impacts.powerGrids.affectedRegions}</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="p-4 bg-space-section rounded-lg border border-space-border hover:border-space-border-hover transition-colors">
                    ...
                    <div className="space-y-1 text-sm">
                        <p>
                            <span className="text-space-text-muted">HF Radio:</span>{" "}
                            <span className="text-orange-400 font-semibold">
                                {impacts.communications.hfRadio}
                            </span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">GPS:</span>{" "}
                            <span className="text-green-400">{impacts.communications.gps}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Satellite Comms:</span>{" "}
                ...
                <div className="p-4 bg-space-section rounded-lg border border-space-border hover:border-space-border-hover transition-colors">
                    ...
                    <div className="space-y-1 text-sm">
                        <p>
                            <span className="text-space-text-muted">Pipelines:</span>{" "}
                            <span className="text-green-400">{impacts.technology.pipelines}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Railways:</span>{" "}
                            <span className="text-green-400">{impacts.technology.railways}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Electronics:</span>{" "}
                    ...
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <InfoTooltip title="Weather Indices Explained:" width="w-80">
                            <p className="text-space-text-muted mb-1">
                                <span className="text-space-text-soft">Dst:</span> Disturbance Storm Time index. Negative values indicate geomagnetic storms.
                            </p>
                            <p className="text-space-text-muted mb-1">
                                <span className="text-space-text-soft">Radiation Belt:</span> Electron flux levels in Earth's radiation belts.
                            </p>
                            <p className="text-space-text-muted mb-1">
                                <span className="text-space-text-soft">Ionospheric:</span> Disturbance in the ionosphere affecting radio propagation.
                            </p>
                            <p className="text-space-text-muted">
                                <span className="text-space-text-soft">Scintillation:</span> Signal degradation risk for GPS and satellite communications.
                            </p>
                        </InfoTooltip>
                    </div>
                    <div className="space-y-1 text-sm">
                        <p>
                            <span className="text-space-text-muted">Dst:</span>{" "}
                            <span className="text-orange-400">{weatherIndices.dst.value.toFixed(1)} nT</span>
                            <span className="text-space-text-soft text-xs ml-2">({weatherIndices.dst.level})</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Radiation Belt:</span>{" "}
                            <span className="text-orange-400">{weatherIndices.radiationBelt.level}</span>
                        </p>
                        <p>
                            <span className="text-space-text-muted">Ionospheric:</span>{" "}
                            <span className="text-yellow-400">{weatherIndices.ionospheric.disturbance}</span>
                        </p>
                        {weatherIndices.scintillation && (
                            <p>
                                <span className="text-space-text-muted">Scintillation Risk:</span>{" "}

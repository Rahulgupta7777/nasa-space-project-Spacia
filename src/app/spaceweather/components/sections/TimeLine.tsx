        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {timeline.recentEvents && timeline.recentEvents.length > 0 && (
                    <div>
                        <h4 className="text-sm font-semibold text-space-text-main mb-3">Recent Events</h4>
                        <div className="space-y-3">
                            {timeline.recentEvents.map((event, i) => (
                                <div key={i} className="p-3 bg-space-section/50 rounded-lg border border-space-border">
                ...
                {timeline.predictions && (
                    <div>
                        <h4 className="text-sm font-semibold text-space-text-main mb-3">Predictions</h4>
                        <div className="space-y-3">
                            <div className="p-3 bg-space-section/50 rounded-lg border border-space-border">
                                <p className="text-xs text-space-text-muted mb-1">Next 24 Hours</p>
                                <p className="text-sm text-gray-200">{timeline.predictions.next24h}</p>
                            </div>
                            <div className="p-3 bg-space-section/50 rounded-lg border border-space-border">
                                <p className="text-xs text-space-text-muted mb-1">Next 48 Hours</p>
                                <p className="text-sm text-gray-200">{timeline.predictions.next48h}</p>
                            </div>
                            <div className="p-3 bg-space-section/50 rounded-lg border border-space-border">
                                <p className="text-xs text-space-text-muted mb-1">Next 72 Hours</p>

...
export default function ProtonEventsCard({ protonEvents }: ProtonEventsCardProps) {
    return (
        <motion.div
            ...
            className="bg-space-card/70 border border-space-border p-5 rounded-xl hover:border-red-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10"
        >
